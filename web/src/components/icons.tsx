/** Inline stroke icons — no icon package, so the bundle stays small and offline-safe. */

export type IconName =
  | 'dashboard' | 'users' | 'user-plus' | 'user' | 'database' | 'clipboard' | 'search'
...
const PATHS: Record<IconName, string> = {
  ...
  database: 'M12 8c4.42 0 8-1.34 8-3s-3.58-3-8-3-8 1.34-8 3 3.58 3 8 3zM20 12c0 1.66-3.58 3-8 3s-8-1.34-8-3M4 5v14c0 1.66 3.58 3 8 3s8-1.34 8-3V5',
  ...
  sort: 'M11 5h10M11 9h7M11 15h10M11 19h7M3 8l3-3 3 3M6 5v14',
};
